...
from .endpoints import trading, production, predictions, crops, regions, data_sync, upload, traffic_light, typhoon, data_quality, export
...
api_router.include_router(typhoon.router, prefix="/typhoon", tags=["typhoon"])
